        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ListOfPurchaseId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PhotographyPurchase", x => new { x.ListOfPhotosId, x.ListOfPurchaseId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PhotographyPurchase_Purchases_ListOfPurchaseId",
                        column: x => x.ListOfPurchaseId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PhotographyPurchase_ListOfPurchaseId",
                table: "PhotographyPurchase",
                column: "ListOfPurchaseId");
